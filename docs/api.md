...
AI Skill Shield exposes JSON APIs under `/api`. The application does not provide built-in authentication, so production deployments should place sensitive endpoints behind an appropriate access-control layer.
